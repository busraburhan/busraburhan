...
public:
    ...
    static bool isThisLastFrame(stack<Packet*> frame);
    static string ReturnMessageFromDeep(stack<Packet*> frame);
    ~Client();
    ...
    queue<stack<Packet*>> temp_incoming_queue;
    queue<stack<Packet*>> temp_outgoing_queue;
