...
public:
    ...
    vector<bool > split(string line , char splitCharacter );
    vector<int> splitLine(string line , char splitCharacter);
    vector<vector<bool>> rotation(vector<vector<bool>> inputVector, bool trueIfRight);
